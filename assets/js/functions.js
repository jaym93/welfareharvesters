        ...
        this_form.submit(function(event)
        {
            ...
            $.ajax({
                ...
                error: function (data) 
                {
                    ...
                    // show error message
                    var error_field_html = '<div class="alert">There seems to be  problem with submitting this form, due to server issues. Please send an email or call us from the details given on the left.</div>';
